...
public final class FrameworkVersion {
    ...
    private static String loadVersion() {
        // 1. MANIFEST.MF Implementation-Version — set by maven-jar-plugin and Gradle jar task.
        ...
        String manifestVersion = FrameworkVersion.class.getPackage() != null
                ...
                : null;
        if (manifestVersion != null && !manifestVersion.isBlank()) return manifestVersion.trim();
